#ifndef EVENTHANDLER_DAMAGE_TAKEN_AGG_H
#define EVENTHANDLER_DAMAGE_TAKEN_AGG_H
...
class t_eventHandler_damage_taken_agg : public QObject
{
    Q_OBJECT

public:
    explicit t_eventHandler_damage_taken_agg(MainWindow *mainWindow);
private:
