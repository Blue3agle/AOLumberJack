...
t_eventHandler_damage_given::t_eventHandler_damage_given(MainWindow *mainWindow)
{
    this->mainWindow = mainWindow;
    this->mainWindow->addModule("DamageGivenGraph");
    ...
    QObject::connect(mainWindow->logParser, &t_parser::lineParsed
                     , this, t_eventHandler_damage_given::handleEvent);

    QObject::connect(this->chart, &QCustomPlot::selectionChangedByUser
                     , this, t_eventHandler_damage_given::graphSelectionChanged);
}

void t_eventHandler_damage_given::setupPlayField()
{
    this->playField = new QMdiSubWindow();
    this->playField->setMinimumSize(400, 200);
    this->playField->setWindowTitle("Damage given");
...
void t_eventHandler_damage_given::handleEvent(t_logLine *log)
{
    QString data = "";
    ...
    if(match.hasMatch()){
        ...
        this->graphLines[source]->addData(offset, value);
/*
...
void t_eventHandler_damage_given::addGraph(QString entity)
{
...
void t_eventHandler_damage_given::graphSelectionChanged()
{
