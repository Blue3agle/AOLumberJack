#ifndef EVENTHANDLER_DAMAGE_TAKEN_H
#define EVENTHANDLER_DAMAGE_TAKEN_H
...
class t_eventHandler_damage_taken : public QObject
{
    Q_OBJECT

public:
    explicit t_eventHandler_damage_taken(MainWindow *mainWindow);
private:
